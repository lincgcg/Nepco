def model_opts(parser):
    parser.add_argument("--embedding", choices=["word"], default="word", nargs='+',
                        help="Embedding type.")
    ...
    parser.add_argument("--encoder", choices=["Nepco"], default="Nepco", help="Encoder type.")
    parser.add_argument("--mask", choices=["fully_visible"], default="fully_visible",
                        help="Mask type.")
    parser.add_argument("--target", choices=["mlm"], default="mlm", nargs='+',
...
def finetune_opts(parser, require_train_dev=True):
    # Path options.
    parser.add_argument("--pretrained_model_path", default=None, type=str,
                        help="Path of the pretrained model.")
    parser.add_argument("--output_model_path", default="models/finetuned_model.bin", type=str,
                        help="Path of the output model.")
    parser.add_argument("--train_path", type=str, required=require_train_dev,
                        help="Path of the trainset.")
    parser.add_argument("--dev_path", type=str, required=require_train_dev,
...
def tokenizer_opts(parser):
    parser.add_argument("--tokenizer", choices=["bert", "space"], default="bert",
