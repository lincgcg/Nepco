...
def main():
    ...
    if args.test_path is not None:
        ...
        if torch.cuda.device_count() > 1:
            args.model.module.load_state_dict(torch.load(args.output_model_path, map_location=args.device))
        else:
            args.model.load_state_dict(torch.load(args.output_model_path, map_location=args.device))
